...
>;
export const customerOrderByCustomerName = /* GraphQL */ `query CustomerOrderByCustomerName(
  $customerName: String!
  $sortDirection: ModelSortDirection
  $filter: ModelCustomerOrderFilterInput
  $limit: Int
...
` as GeneratedQuery<
  APITypes.CustomerOrderByCustomerNameQueryVariables,
  APITypes.CustomerOrderByCustomerNameQuery
>;
