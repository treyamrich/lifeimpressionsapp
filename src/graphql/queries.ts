...
`;
export const tshirtsByStyleNumber = /* GraphQL */ `
  query TshirtsByStyleNumber(
    $styleNumber: String!
...
`;
export const tshirtTransactionQueues = /* GraphQL */ `
...
`;
export const customerOrderByCustomerName = /* GraphQL */ `
