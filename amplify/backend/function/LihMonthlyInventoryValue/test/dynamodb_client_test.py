...
class TestDynamoDBClient(unittest.TestCase):
    ...
    def test_batch_write_to_db(self):
        ...
        self.dynamodb_client.batch_write_item(self.table_name, items)
    ...
    def test_to_update_partiql(self):
        ...
        statement, params = DynamoDBClient._to_update_partiql(self.table_name, self.pk_field_name, item)
    ...
    def test_retry_batch_execute_statement(self):
        ...
        self.dynamodb_client.batch_execute_statement(self.table_name, self.pk_field_name, items)
